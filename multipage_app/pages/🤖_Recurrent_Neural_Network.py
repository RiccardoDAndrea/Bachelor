    ...
    try:
        ...
        with st.spinner('Model training in progress...'):
            ...
            try:
                ...
                st.info(f"""
                    - It appears that the number of neurons in the last hidden layer is incorrect.
                    The output shape of your hidden layer should match the shape of your input values for :red[{forecast_Var}].
                    Please adjust the number of neurons in your last hidden layer to ensure compatibility with the input data.
                    
                    - Second possibility is that the learning rate is too high or too low. 
